    ...
    <Swipe prev={"/contact"} next={"/about"}>
      <main className="flex flex-col text-white">
        ...
        <div className="bg-[#f60] p-10 ">
          <h3 className="flex flex-col md:flex-row items-center gap-4 justify-evenly text-xl">
            Do you have project in your head? <MessageModal />
          </h3>
        </div>
      </main>
    </Swipe>
